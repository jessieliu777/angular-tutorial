...
export class ProductDetailsComponent implements OnInit {
  ...
  // ActivatedRoute is specific to each component that the Angular Router loads. ActivatedRoute contains information about the route and the route's parameters. This is configuring the component to use a service.
  constructor(
